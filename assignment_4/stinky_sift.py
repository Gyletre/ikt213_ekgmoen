...
def match_imgs_SIFT(image_to_align, referance_image, max_features, good_match_percent):
    ...
    cv2.imwrite(dirname+"/images/SIFT_matched_with_min_acc={}%.png".format(good_match_percent),img_matches)
...
match_imgs_SIFT(align_image,referance_image,1000,85)
